...
- Task 17 concluída em desenvolvimento: treinador cria treinos manuais por blocos em `/treinador/treinos/novo` e lista os próprios treinos em `/treinador/treinos`; a autoria e a assessoria vêm exclusivamente da sessão e a estrutura é validada no servidor e no banco.
- CRUD de avaliações;
