...
4. A operação inicial usará Vercel Hobby: cron diário, processamento em lotes e webhooks para fatos externos; frequência maior só será reavaliada se métricas reais exigirem.
