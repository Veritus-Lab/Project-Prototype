...
Atualizado em 14/09/2026. Tasks 01–09 CONCLUÍDAS; Tasks 10–34 serão executadas sob o escopo de gestão administrativa e financeira. Treino é legado preservado, fora de toda experiência ativa.
...
| 07 — Papéis e permissões | **CONCLUÍDA.** Sócio, professor e aluno; autorização em banco/servidor, backfill legado e status financeiro agregado para professor | 06 | Testes negativos por papel e por aluno passam; professor consulta somente `em dia`, `pendente`, `não configurado` ou `indisponível`, sem detalhes financeiros |
| 08 — Acesso exclusivo FLERNK | **CONCLUÍDA.** Cadastro público e bootstrap desativados; convite de equipe cria conta individual vinculada ao e-mail convidado; proteção do último sócio ativo | 07 | Fluxo antigo não cria organização nem eleva papel; último sócio protegido; contas provisionadas em ambiente apropriado |
| 09 — Estrutura dos portais | **CONCLUÍDA.** Portais de sócio, professor e aluno; menus por papel; recuperação e redefinição de senha; rotas de treino fora da navegação ativa | 08, 03 | Cada papel chega ao painel correto em desktop/celular, sem exposição de dados ou referências a treino |
